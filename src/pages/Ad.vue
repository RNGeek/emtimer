<template>
  <container>
    <mu-paper v-if="visible" class="paper" :z-depth="3">
      <mu-sub-header class="header">
        <mu-icon-button class="close-botton" icon="close" @click="hide"/>
        <div class="header-text">💡 Pokémon RNG Advent Calendar 2017 の宣伝</div>
      </mu-sub-header>
